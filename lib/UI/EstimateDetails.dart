  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:SingleChildScrollView(
          child: Column(
            children: [
              const FormTextField("sorId*","e.g. 251c51eb-e970-4e01-a99a-70136c47a934","Estimate Details"),
              const FormTextField("Name*","e.g. Estimate Details","Estimate Details"),
              const FormTextField("Category","e.g. Overhead, SOR, non-SOR","Estimate Details"),
              const FormTextField("uom", "e.g. Kilogram, meter, number","Estimate Details"),
              const FormTextArea("Description", "e.g. text","Estimate Details"),
              Container(
                margin: const EdgeInsets.all(20),
                child: const Addbutton("Add Multiple Estimate Details", "Estimate Details")
              ),
            ],
                ),
        ),
